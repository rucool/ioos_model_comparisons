...
from ioos_model_comparisons.platforms import (get_active_gliders, get_argo_floats_by_time,
                                  get_bathymetry)
from ioos_model_comparisons.plotting import plot_model_region, plot_model_region_currents
...
tomorrow = dt.datetime(2023, 2, 1, 0, 0, 0)
past = dt.datetime(2023, 1, 31, 12, 0, 0)
...
with rtofs() as ds:
    ...
    for item in configs.regions:
        ...
        for time in date_list:
            ...
            plot_model_region_currents(tds.sel(time=time), region, **kwargs)
