...
models = ["gofs", "rtofs"] # Which model: rtofs or gofs.. or both?
t0 = dt.datetime(2021, 5, 1)
t1 = dt.datetime(2021, 12, 1)
# t0 = dt.datetime(2021, 8, 1)
# t1 = dt.datetime(2021, 8, 10)
region_key = "western_atlantic" # specify the region in order to grab the extents of that region
subdir = "2021_hurricane_season_western_atlantic"
...
# Caribbean PR/VI
# plot_dict = 
# plot_dict[0] = dict(temp=[24, 30, .5], haline=[36, 37, .05])
# 0m
# depth = 0
# temp_range = [24, 30, .5] # [min, max, step]
