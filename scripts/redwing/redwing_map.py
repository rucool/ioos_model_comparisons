...
def plot_redwing_map(
    ...
    def init_axis(ax, add_legend: bool = False, add_text: bool = False):
        ...
        ax.set_xticks(np.arange(-40, -14, 5), crs=ccrs.PlateCarree())
        ax.set_yticks(np.arange(30, 36, 5), crs=ccrs.PlateCarree())
        ax.set_xticks(np.arange(-43, -14, 1), minor=True, crs=ccrs.PlateCarree())
        ax.set_yticks(np.arange(28, 38, 1), minor=True, crs=ccrs.PlateCarree())
    ...
    if surface_ds is not None:
        ...
        title_str = f"Sentinel Mission - Redwing Track\n {model_title} - {title_time}"
    else:
    ...
    if depth_avg_ds is not None:
        ...
        depth_title = (
            f"Sentinel Mission - Redwing Track\n"
