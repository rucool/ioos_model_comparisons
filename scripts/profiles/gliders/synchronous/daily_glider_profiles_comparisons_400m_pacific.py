        ...
        if not tdf.empty:
            for name, pdf in tdf.groupby(['profile_id', 'time', 'lon', 'lat']):
                if not pdf.empty:
                    ...
                    tax.plot(temp_glider, depth_glider, '.', color='cyan', markeredgecolor='black', markeredgewidth=0.4, label='_nolegend_')
                    sax.plot(salinity_glider, depth_glider, '.', color='cyan', markeredgecolor='black', markeredgewidth=0.4, label='_nolegend_')
                    dax.plot(density_glider, depth_glider, '.', color='cyan', markeredgecolor='black', markeredgewidth=0.4, label='_nolegend_')
