...
from ioos_model_comparisons.platforms import (get_argo_floats_by_time,
                                              get_glider_by_id)
from ioos_model_comparisons.plotting import cmaps
from ioos_model_comparisons.regions import region_config
from mpl_toolkits.axes_grid1.inset_locator import inset_axes
from pytz import timezone

pdf = pd.read_csv('/Users/mikesmith/Documents/data/argo/whoi_argo_complete_profiles.csv', parse_dates=['time'])
...
t0 = dt.datetime(2021, 8, 27, 0, 0, 0)
t1 =  dt.datetime(2021, 8, 31, 0, 0, 0)
model = 'rtofs'
days = 2
argo = True
gliders = True
...
t0_search = pd.to_datetime(ds.time.data[0] - np.timedelta64(search_hours, 'h'))
...
for region in regions:
    ...
    glider = get_glider_by_id(dataset_id=glider, bbox=extent, start=t0_glider, end=t1)
    ...
    for k, v in limits.items():
        ...
        for item in v:
            ...
            fig, ax = create(extent, bathymetry=True, isobaths=())
