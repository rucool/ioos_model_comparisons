...
dir = '/Users/mikesmith/Downloads/rtofs/'
fn_maps = dir+'rtofs.20231013/rtofs_glo.t00z.f12.archv.a'  ## Map has the initial time. "What you see before deploying"
...
trajectory = {'datetime': [dt.datetime(2023,10,13,12,0,0)]
            , 'lon': [166], 'lat': [0]}
